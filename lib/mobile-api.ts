...
import { backdropUrl, getMovieContentRating, getTVContentRating, logoUrl, posterUrl, profileUrl, stillUrl } from "@/lib/tmdb";
...
export function serializeMovieDetails(movie: MovieDetails, credits: Credits, related: Movie[] | null | undefined, rottenTomatoesScore: number | null, logo: TMDBImageAsset | null = null): MobileMediaDetails {
