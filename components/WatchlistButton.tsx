...
export default function WatchlistButton({ item }: { item: WatchlistInput }) {
  ...
  return (
    <button
      ...
      aria-pressed={added}
      className={`inline-flex items-center gap-2 rounded-full border h-12 px-7 text-base font-semibold transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent-red/60 ${
        added
