...
export default function MediaCard({ item }: { item: MediaItem }) {
  ...
  return (
    <Link href={href} className="group block flex-shrink-0">
      <div className="relative w-[160px] sm:w-[185px] overflow-hidden rounded-xl bg-card transition-all duration-300 group-hover:scale-[1.04] group-hover:shadow-[0_0_30px_rgba(245,158,11,0.15)]">
